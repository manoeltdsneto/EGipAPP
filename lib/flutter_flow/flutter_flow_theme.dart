...
abstract class FlutterFlowTheme {
  ...
  late Color azul500;
  late Color pendente;
  late Color emAndamento;
  late Color concluido;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0265CB);
  ...
  late Color orange500 = const Color(0xFFFE8F32);
  late Color azul500 = const Color(0xFFE6F2FF);
  late Color pendente = const Color(0xFFFB060A);
  late Color emAndamento = const Color(0xFFF16A0D);
  late Color concluido = const Color(0xFF10AB24);
}
