...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    egip20082025AuthUserSubject.add(
      Egip20082025AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Egip20082025AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Egip20082025AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Egip20082025AuthUser(
      loggedIn: true,
      uid: authUid,
    );
    egip20082025AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
Egip20082025AuthUser? currentUser;
