            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (_model.isActiveUsuarios == false) {
                      await actions.verificarConexaoInternet(
                        context,
                      );
                      _model.isActiveUsuarios = true;
                      safeSetState(() {});
                      if (FFAppState().temInternet == true) {
                        _model.getUsers = await BuscarUsuariosCall.call();

                        FFAppState().usuarios =
                            ((_model.getUsers?.jsonBody ?? '')
                                    .toList()
                                    .map<UsuariosStruct?>(
                                        UsuariosStruct.maybeFromMap)
                                    .toList() as Iterable<UsuariosStruct?>)
                                .withoutNulls
                                .toList()
                                .cast<UsuariosStruct>();
                        safeSetState(() {});
                        if (FFAppState().usuarios.length > 0) {
                          await SQLiteManager.instance.deleteAllUsers();
                          _model.contador = -1;
                          safeSetState(() {});
                          _model.timerUsers = InstantTimer.periodic(
                            duration: Duration(milliseconds: 1000),
                            callback: (timer) async {
                              while (_model.contador <=
                                  FFAppState().usuarios.length) {
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: ToasWidget(
                                        titulo: 'Tabela atualizada',
                                        texto:
                                            'Sua tabela usuarios foi atualizada com sucesso!',
                                        icone: Icon(
                                          Icons.check,
                            ...
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: ToasWidget(
                                  titulo: 'Sem conexão',
                                  texto:
                                      'Você está sem internet, verifique sua conexão',
                                  icone: Icon(
                                    Icons.wifi_off,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                if (_model.isActiveUsuarios == true)
                                  ClipRRect(
