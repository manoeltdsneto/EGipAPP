...
class MapaRotaWidget extends StatefulWidget {
  ...
  static String routeName = 'mapaRota';
  static String routePath = '/mapaRota';
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  height: 600.0,
                  child: custom_widgets.GoogleMapRotaWidget(
                    width: double.infinity,
                    height: 600.0,
                    destinoLat: double.parse(FFAppState().rotaDestino.latitude),
                    destinoLng:
                        double.parse(FFAppState().rotaDestino.longitude),
                  ),
                ),
              ),
            ],
