...
import 'editar_luminaria_widget.dart' show EditarLuminariaWidget;
...
class EditarLuminariaModel extends FlutterFlowModel<EditarLuminariaWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Custom Action - listarBairrosUnicosComContagem] action in editarLuminaria widget.
